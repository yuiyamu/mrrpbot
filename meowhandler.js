...
var nyaMatch = [/^(m(r{2,})p)/, /^(m(e+)(o+)w)/, /^(m(r+)(o+)w)/ ,/^(p(u+)(r{2,}))/, /^(m(e+)(w+))/, /^(n(y+)(a+)+)/, /^((ps+))/, /^(m(i+)(a+)(u+))/, /^(m(y+)(a+)(u+))/, /^(m(a+)(u+))/, /^(m(a+)(o+))/];
var yellingNyaMatch = [/^(M(R{2,})P)/, /^(M(E+)(O+)W)/,  /^(M(R+)(O+)W)/, /^(P(U+)(R{2,}))/, /^(M(E+)(W+))/, /^(N(Y+)(A+))/, /^((PS+))/, /^(M(I+)(A+)(U+))/,  /^(M(Y+)(A+)(U+))/, /^(M(A+)(U+))/, /^(M(A+)(O+))/];
